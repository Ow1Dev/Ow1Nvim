      ...
      let
        ...
        installedNeovim = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            ...
            # Simple wrapper - Home Manager handles the config symlinking
      ...
      homeManagerModules.default = { config, lib, pkgs, ... }: 
        ...
        in {
          ...
          config = lib.mkIf config.programs.neovim-flake.enable {
            ...
            xdg.configFile = {
              "nvim-flake/init.lua".source = flakePkgs.installed + "/share/nvim/init.lua";
              "nvim-flake/.luarc.json".source = flakePkgs.installed + "/share/nvim/.luarc.json";
              "nvim-flake/lua".source = flakePkgs.installed + "/share/nvim/lua";
              "nvim-flake/lsp".source = flakePkgs.installed + "/share/nvim/lsp";
            };
          };
        };
    };
